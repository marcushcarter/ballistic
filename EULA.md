...
You may:
- Use the Software to create and distribute applications, games, and other digital content. 
- Use provided APIs, tools, and extension systems to interact with the Software.
- Create and distribute projects made using the Software.

5. USER CONTENT

You retain ownership of content created using the Software, including:
- Source code
- Game logic
- Models
- Textures
...
You may not:
- Copy, redistribute, sell, sublicense, rent, or lease the Software.
- Modify, adapt, or create derivative versions of the Software.
- Reverse engineer, decompile, or disassemble the Software.
- Attempt to extract source code or proprietary technology.
- Create a competing engine based on the Software.
- Remove copyright notices, trademarks, or ownership information.

7. THIRD-PARTY SOFTWARE

The Software may include third-party libraries, tools, or components. Such components are provided under their respective licenses and terms.
