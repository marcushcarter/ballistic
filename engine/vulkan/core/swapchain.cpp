...
{
bool Swapchain::Create(VkPhysicalDevice physicalDevice, VkDevice device, VkSurfaceKHR surface, VkExtent2D windowExtent, VkPresentModeKHR presentMode, VkSwapchainKHR oldSwapchain)
{
    ...
    // VkPresentModeKHR selectedMode = VK_PRESENT_MODE_FIFO_KHR; // guaranteed fallback
    ...
    createInfo.presentMode = selected;
...
bool Swapchain::Resize(VkExtent2D newExtent, VkPresentModeKHR presentMode)
{
    VkSwapchainKHR oldSwapchain = swapchain;

    extent = newExtent;
    if (!Create(physicalDeviceHandle, deviceHandle, surfaceHandle, extent, presentMode, oldSwapchain)) {
