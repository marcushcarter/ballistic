...
void MainZPass::AddPass(RenderGraph& g, FrameGraph& fg)
{
    ...
    [this](VkCommandBuffer cmd, const PassData& data, RenderGraph& g)
    {
        ...
        (void)cmd;
        // vkCmdBeginRendering(cmd, &info); //when this is uncommented my entire program freezes after you loaded a project
        // vkCmdEndRendering(cmd); // this too
    });
